...
path = "C:\\Users\\Usuario\\Documents\\IC\\TemperatureCloudTop\\Temperature-Analysis\\samples\\OR_ABI-L2-CMIPF-M6C13_G16_s20193010820381_e20193010830100_c20193010830195.nc"
...
plt.text(extent[2] + lon_difference * 0.2, extent[1] + lat_difference * 0.5 ,ColorBarLabel, verticalalignment ='center', rotation = "vertical", color = 'black', size=40)

# Save the result as a PNG
time_saved = timeScan.replace(':','_')
plt.savefig('SA_G16_C' + str(Band) + '_' + date + '_' + time_saved +'.tif', dpi=DPI, pad_inches=0,bbox_inches='tight', transparent=True)
plt.close()
